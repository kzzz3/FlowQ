...
[[nodiscard]] inline connection_loop_config to_connection_config(const session_config& config) {
    ...
    connection_config.handshake_rx_protector = config.handshake_rx_protector;
    connection_config.application_tx_protector = config.application_tx_protector;
    connection_config.application_rx_protector = config.application_rx_protector;
    connection_config.packet_protector_refresh = config.packet_protector_refresh;
...
inline void apply_transport_parameters(session_config& config, const transport_parameters& parameters) {
    auto connection_config = to_connection_config(config);
    apply_transport_parameters(connection_config, parameters);
    config.max_idle_timeout = connection_config.max_idle_timeout;
    config.max_udp_payload_size = connection_config.max_udp_payload_size;
    config.max_packet_payload_size = connection_config.max_packet_payload_size;
    config.initial_connection_send_max_data = connection_config.initial_connection_send_max_data;
    config.initial_max_stream_data_bidi_local = connection_config.initial_max_stream_data_bidi_local;
    config.initial_max_stream_data_bidi_remote = connection_config.initial_max_stream_data_bidi_remote;
    config.initial_max_stream_data_uni = connection_config.initial_max_stream_data_uni;
    config.initial_stream_send_max_data = connection_config.initial_stream_send_max_data;
