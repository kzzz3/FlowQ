...
- **Latest recheck**: 2026-05-30 after FlowQ commit `09eca19`; rebuilt `flowq_quic_client.exe` from the OpenSSL interop tree and ran in conda environment `expr`; `bidirectional_stream` and `loss_recovery` both passed against aioquic 1.3.0.
