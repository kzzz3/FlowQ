...
2. Record a human security review in `docs/security/reviews/human-security-review.md` so `scripts/validate-security-evidence.py` can verify the strict-gate fields.
3. Record an external security audit in `docs/security/audits/external-security-audit.md` before public secure or production-ready claims.
