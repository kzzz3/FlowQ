...
- [ ] **Step 3: Implement structural codecs**
...
- [ ] **Step 3: Implement minimal state handlers**
...
- Spec coverage: Adds reset/stop codecs, minimal stream effects, connection routing, docs.
